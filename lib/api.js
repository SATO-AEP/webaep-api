...
if (((_sato = sato) === null || _sato === void 0 ? void 0 : _sato.isPrinter) === true) {
...
function _connect() {
  _connect = _asyncToGenerator(function* () {
    ...
    if (typeof ((_psim = psim) === null || _psim === void 0 ? void 0 : _psim.getPort) == 'function') {
      // eslint-disable-next-line no-undef
...
var _default = {
  ...
  isPrinter() {
    ...
    return ((_sato2 = sato) === null || _sato2 === void 0 ? void 0 : _sato2.isPrinter) === true;
  },
